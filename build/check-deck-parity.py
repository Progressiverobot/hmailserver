...
def write_markdown(interfaces, desktop, routes, views, view_calls, rows, method_rows,
    ...
    a('This measures how far the browser administration page (the Control Deck at '
      '`/WebAdmin`, which speaks the twenty languages the webmail speaks, from the catalogues '
      'in `WebAdmin/languages`) and the REST API are from the desktop Control Panel, from the sources '
