...
* **POP3**, including retrieval from external POP3 accounts on a schedule - and from external **IMAP** accounts (`ServerType` 1: the INBOX, collected once by UID and left on the server unless told otherwise).
