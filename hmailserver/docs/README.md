...
| [Fuzzing.md](Fuzzing.md) | Fuzzing the parsers with libFuzzer and AddressSanitizer: the harnesses under `fuzz/`, how to build and run them, the crash oracle the regression suite checks after every test, and what is covered (MIME, done) and what is not yet (HTML, iCalendar, vCard). |
