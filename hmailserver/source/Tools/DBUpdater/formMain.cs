...
namespace DBUpdater
{
   public partial class formMain : Form
   {
      ...
      private void LoadScripts()
      {
         ...
         _upgradeScripts.Add(new UpgradeScript(6014, 6015));
         _upgradeScripts.Add(new UpgradeScript(6015, 6016));
         _upgradeScripts.Add(new UpgradeScript(6016, 6017));
         _upgradeScripts.Add(new UpgradeScript(6017, 6018));
         _upgradeScripts.Add(new UpgradeScript(6018, 6019));
         _upgradeScripts.Add(new UpgradeScript(6019, 6020));
         _upgradeScripts.Add(new UpgradeScript(6020, 6021));
         _upgradeScripts.Add(new UpgradeScript(6021, 6022));
         _upgradeScripts.Add(new UpgradeScript(6022, 6023));
         _upgradeScripts.Add(new UpgradeScript(6023, 6024));
         _upgradeScripts.Add(new UpgradeScript(6024, 6025));
         _upgradeScripts.Add(new UpgradeScript(6025, 6026));
         _upgradeScripts.Add(new UpgradeScript(6026, 6027));
         _upgradeScripts.Add(new UpgradeScript(6027, 6028));
         _upgradeScripts.Add(new UpgradeScript(6028, 6029));
         _upgradeScripts.Add(new UpgradeScript(6029, 6030));
         _upgradeScripts.Add(new UpgradeScript(6030, 6031));
         _upgradeScripts.Add(new UpgradeScript(6031, 6032));
         ...
         _upgradeScripts.Add(new UpgradeScript(6036, 6037));
         _upgradeScripts.Add(new UpgradeScript(6037, 6038));
         ...
         _upgradeScripts.Add(new UpgradeScript(6042, 6043));
         _upgradeScripts.Add(new UpgradeScript(6043, 6044));
         _upgradeScripts.Add(new UpgradeScript(6044, 6045));
      }
      ...
      private string GetDatabaseVersionName(int version)
      {
         switch (version)
         {
            ...
            case 6015:
               return "hMailServer 6.2 (6015)";
            case 6016:
               return "hMailServer 6.2 (6016)";
            case 6017:
               return "hMailServer 6.2 (6017)";
            case 6018:
               return "hMailServer 6.2 (6018)";
            case 6019:
               return "hMailServer 6.2 (6019)";
            case 6020:
               return "hMailServer 6.2 (6020)";
            case 6021:
               return "hMailServer 6.2 (6021)";
            case 6022:
               return "hMailServer 6.2 (6022)";
            case 6023:
               return "hMailServer 6.2 (6023)";
            case 6024:
               return "hMailServer 6.2 (6024)";
            case 6025:
               return "hMailServer 6.2 (6025)";
            case 6026:
               return "hMailServer 6.2 (6026)";
            case 6027:
               return "hMailServer 6.2 (6027)";
            case 6028:
               return "hMailServer 6.2 (6028)";
            case 6029:
               return "hMailServer 6.2 (6029)";
            case 6030:
               return "hMailServer 6.2 (6030)";
            case 6031:
               return "hMailServer 6.2 (6031)";
            case 6032:
               return "hMailServer 6.3 (6032)";
            case 6033:
               return "hMailServer 6.3 (6033)";
            case 6034:
            ...
            case 6037:
               return "hMailServer 6.3 (6037)";
            case 6038:
               return "hMailServer 6.3 (6038)";
            case 6039:
               return "hMailServer 6.3 (6039)";
            case 6040:
            ...
            case 6043:
               return "hMailServer 6.3 (6043)";
            case 6044:
               return "hMailServer 6.3 (6044)";
            case 6045:
               return "hMailServer 6.3 (6045)";
            default:
