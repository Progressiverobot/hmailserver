...
ALTER TABLE hm_audit ADD CONSTRAINT hm_audit_pk PRIMARY KEY (auditid)
...
ALTER TABLE hm_alertrules ADD CONSTRAINT hm_alertrules_pk PRIMARY KEY (alertruleid)
...
ALTER TABLE hm_alertevents ADD CONSTRAINT hm_alertevents_pk PRIMARY KEY (alerteventid)
