...
ALTER TABLE hm_accounts DROP CONSTRAINT fk_hm_accounts_domain --- [IGNORE-ERRORS]
...
ALTER TABLE hm_aliases DROP CONSTRAINT fk_hm_aliases_domain --- [IGNORE-ERRORS]
...
ALTER TABLE hm_domain_aliases DROP CONSTRAINT fk_hm_domain_aliases_domain --- [IGNORE-ERRORS]
...
ALTER TABLE hm_distributionlists DROP CONSTRAINT fk_hm_distributionlists_domain --- [IGNORE-ERRORS]
...
ALTER TABLE hm_distributionlistsrecipients DROP CONSTRAINT fk_hm_dlrecipients_list --- [IGNORE-ERRORS]
...
ALTER TABLE hm_routeaddresses DROP CONSTRAINT fk_hm_routeaddresses_route --- [IGNORE-ERRORS]
...
ALTER TABLE hm_fetchaccounts DROP CONSTRAINT fk_hm_fetchaccounts_account --- [IGNORE-ERRORS]
...
ALTER TABLE hm_fetchaccounts_uids DROP CONSTRAINT fk_hm_fetchaccounts_uids_fa --- [IGNORE-ERRORS]
...
ALTER TABLE hm_apppasswords DROP CONSTRAINT fk_hm_apppasswords_account --- [IGNORE-ERRORS]
...
ALTER TABLE hm_rule_criterias DROP CONSTRAINT fk_hm_rule_criterias_rule --- [IGNORE-ERRORS]
...
ALTER TABLE hm_rule_actions DROP CONSTRAINT fk_hm_rule_actions_rule --- [IGNORE-ERRORS]
...
ALTER TABLE hm_group_members DROP CONSTRAINT fk_hm_group_members_group --- [IGNORE-ERRORS]
...
ALTER TABLE hm_passwordhistory DROP CONSTRAINT fk_hm_passwordhistory_account --- [IGNORE-ERRORS]
...
ALTER TABLE hm_messagerecipients DROP CONSTRAINT fk_hm_messagerecipients_message --- [IGNORE-ERRORS]
...
ALTER TABLE hm_message_metadata DROP CONSTRAINT fk_hm_message_metadata_message --- [IGNORE-ERRORS]
...
ALTER TABLE hm_imapexpunged DROP CONSTRAINT fk_hm_imapexpunged_folder --- [IGNORE-ERRORS]
...
ALTER TABLE hm_messageindexterms DROP CONSTRAINT fk_hm_messageindexterms_message --- [IGNORE-ERRORS]
