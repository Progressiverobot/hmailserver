...
#include "../Util/Time.h"
// The SQL Server Compact SDK headers, which ship with the Windows redistributable
// and exist nowhere else. Guarded for the same reason the body below is; see the
// note above the namespace.
#ifdef _MSC_VER
