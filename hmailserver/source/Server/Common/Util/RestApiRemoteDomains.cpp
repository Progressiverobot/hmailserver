...
namespace HM
{
   ...
   RestApiServer::OpenApiRemoteDomainsPaths_()
   {
      return
         ...
         "\"get\":{\"summary\":\"The policy that governs a domain\",\"description\":\"Which record a delivery to ?domain=example.com will actually use. Not the same question as the record NAMED by that domain: an exact name beats any pattern, a longer pattern beats a shorter one, and an inactive record governs nothing rather than falling through to a broader one. Answers 404 when no policy governs the domain, which means the delivery is unconstrained. Server-wide; refused for domain-restricted keys.\",\"responses\":{\"200\":{\"description\":\"The governing policy, as the listing shows it\"},\"400\":{\"description\":\"domain is required\"},\"404\":{\"description\":\"No policy governs that domain\"}}}}"
