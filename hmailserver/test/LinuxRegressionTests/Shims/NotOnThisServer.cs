...
namespace RegressionTests.Shared
{
   ...
   public static class NotOnThisServer
   {
      ...
      private static readonly Dictionary<string, string> Registry = new Dictionary<string, string>
      {
         ...
         { "RegressionTests.SSL.PostQuantumKeyExchange.EmptyGroupList_FallsBackToClassicalGroups", ClassicalKeyExchangeOnly },
         ...
         { "RegressionTests.Security.PasswordHashCost.NewPbkdf2HashCarriesTheConfiguredIterations", NoSecretReadback },
         { "RegressionTests.Security.PasswordHashCost.OutOfRangeWorkFactorFallsBackToTheDefaultAndIsReported", NoSecretReadback },
         { "RegressionTests.Security.PasswordHashCost.LoweringTheIterationsLeavesStoredHashesAlone", NoSecretReadback },
         { "RegressionTests.Security.PasswordHashCost.LogonReDerivesACheaperHashUnderTheRaisedIterations", NoSecretReadback },
         { "RegressionTests.Security.PasswordScrypt.ANewPasswordIsStoredAsScryptAndVerifies", NoSecretReadback },
         { "RegressionTests.Security.PasswordScrypt.APbkdf2AccountIsUpgradedToScryptOnLogonWhenPreferred", NoSecretReadback },
         { "RegressionTests.Security.PasswordScrypt.ALogonNeverDowngradesAScryptHash", NoSecretReadback },
         { "RegressionTests.Security.PasswordScrypt.AMinimumOfEitherMemoryHardSchemeAcceptsBoth", NoSecretReadback },
