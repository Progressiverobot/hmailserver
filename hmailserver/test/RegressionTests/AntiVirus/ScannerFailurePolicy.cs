...
namespace RegressionTests.AntiVirus
{
   ...
   public class ScannerFailurePolicy : TestFixtureBase
   {
      ...
      /// <summary>
      ///    Stores a [Settings] key, or removes it when value is null, in the settings
      ///    store over COM - from schema 6042 an edit to hMailServer.ini is put back at
      ///    the next start, so rewriting the file's lines no longer changes anything.
      /// </summary>
